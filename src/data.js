...
export function GetKanbanData(locale = "en") {
  const text = {
      en: ["Research", "Displaying data from data source", "Showing cover and title", "Property validation", "formatFunction and formatSettings", "Expand/collapse arrow", "Virtual scrolling", "Deferred scrolling", "Infinite scrolling", "Visible/hidden columns", "Public methods", "Editing", "Header", "Dragging with feedback", "Vertical virtualization", "Observable columns array", "Reusing existing HTML elements", "Virtualize collapsed cards"],
      he: ["מחקר", "הצגת נתונים ממקור נתונים", "מראה כריכה וכותרת", "אימות נכס", "formatFunction ו formatSettings", "הרחב / כווץ חץ", "גלילה וירטואלית", "גלילה נדחית", "גלילה אינסופית", "עמודות גלויות / מוסתרות", "שיטות ציבוריות", "עריכה", "כותרת עליונה", "גרירה עם משוב", "וירטואליזציה אנכית", "מערך עמודות ניתן לצפייה", "שימוש חוזר באלמנטים HTML קיימים", "וירטואליזציה של כרטיסים שהתמוטטו"],
    },
    tags = {
    ...
    msInDay = 86400000,
    comments = ["Ut ultrices dolor vitae magna lacinia vehicula.", "Lorem ipsum dolor sit amet, consectetur adipiscing elit.", "Donec vitae dapibus mauris, quis cursus nibh.", "Aenean ultrices maximus ex id scelerisque. Suspendisse cursus maximus nulla, sed ornare lectus aliquet eu. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.", "Curabitur at accumsan metus, rhoncus porttitor ligula.", "Nulla sodales faucibus accumsan."]
